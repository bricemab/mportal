...
import {AuthenticationErrors, GeneralErrors} from "../utils/BackendErrors";
...
export default class AuthMiddleware {
  public static async checkAuth(expressRequest: Request, response: Response, next: NextFunction) {
    ...
    let userId = null;
    try {
      const decoded = jwt.verify(jwtToken, config.security.jwt.secret) as JwtSession;
