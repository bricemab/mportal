...
import ImageTheo from '@/assets/ressources/avatar.jpg'
import ImageBrice from '@/assets/ressources/brice.webp'
...
const user = {
  ...
  position: 'CEO',
  avatar: useUserStore().getUser()!.email.includes("brice") ? ImageBrice : ImageTheo,
}
...
<template>
  <div class="relative" ref="dropdownRef">
    ...
    <div v-show="showDropdown"
      ...
      <router-link to="/settings" class="flex items-center block px-4 py-2 hover:bg-gray-100 hover:rounded-md">
