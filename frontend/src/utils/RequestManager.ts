...
import type { ApplicationReject, ApplicationResponse } from '@/types/GlobalTypes'
...
export default class RequestManager {
  ...
  static sendResponse(response: Response, dataToSend: ApplicationResponse<any>, status?: number) {
  ...
  static executePost<DataType>(url: string, params: any, specialConfig?: AxiosRequestConfig) {
